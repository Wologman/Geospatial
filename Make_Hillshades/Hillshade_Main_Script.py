...
layers = QgsProject.instance().mapLayers()  # returns a dict, keys are a unique seq, vals are the layer object
...
input_rasters, layer_types = find_dem.find_dem_raster()
dem_style.make_terrain(input_rasters, prjpath)
